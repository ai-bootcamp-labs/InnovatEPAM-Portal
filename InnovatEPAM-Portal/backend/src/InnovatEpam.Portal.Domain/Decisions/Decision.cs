...
public sealed class Decision
{
    ...
    private Decision(Guid id, Guid ideaId, DecisionAction action, string? comment, Guid decidedById, DateTimeOffset decidedAt)
    {
        Id = id;
        IdeaId = ideaId;
        Action = action;
    ...
    public static Decision Create(Guid ideaId, DecisionAction action, string? comment, Guid decidedById, DateTimeOffset decidedAt)
    {
        ...
        return new Decision(Guid.NewGuid(), ideaId, action, trimmed, decidedById, decidedAt);
    }
}
